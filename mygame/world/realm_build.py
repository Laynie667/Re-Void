...
_ROOM_AMBIENT = {
    "lobby": [
        ...
        "|xA laminated notice lists INTAKE TERMS in a font too small to read from the chairs. Nobody's given the time to read it anyway.|n",
        "|xPast the desk a door opens on a wet, rhythmic sound and closes again, and the clerk doesn't react — to her it's just the building breathing.|n",
        "|xThe pen on its little chain has been chewed at the cap by a hundred nervous applicants. Your own thumb finds the same spot.|n",
        "|xThe chairs are bolted down and angled, very slightly, toward the intake door — so however you sit, you're already facing where you're going.|n",
    ],
    "holding": [
        ...
        "|xBehind the glass a cow on the line turns her head and looks back out at the holding room — at the chairs, at the waiting — with an expression you can't read and won't forget.|n",
        "|xThe number you were given is printed on a soft band already fastened to your wrist. There's no clasp on your side of it. You checked.|n",
        "|xAn attendant comes for the called number and walks them through the inner door with a hand at the small of the back — guiding, not forcing, which is somehow worse.|n",
        "|xThe holding room is kept a few degrees too warm, the chairs too soft, the wait too long — every comfort tuned to make the door at the end feel like relief when it opens for you.|n",
    ],
    "floor": [
    ...
    "parlour": [
        ...
        "|xThe portfolio wall is a grid of finished work — bellies, flanks, faces — each labelled with an owner and a date, and a few blank slots left at the end, waiting, sized about right for you.|n",
        "|xThe marker considers a stencil against your skin, head tilted, the way an artist sizes a canvas — and you understand, cold and clear, that to her that's exactly what you are.|n",
        "|xA tray of fresh needles and rings is laid out and counted, click by click, by gloved hands in no hurry at all. The counting is somehow worse than the work.|n",
    ],
    "office": [
        ...
        "|xYour file is thick on her desk — thicker than you remember being — and she pats it absently, fondly, the way you'd pat a pet, while she reads something in it that makes her smile.|n",
        "|xBethany hums something tuneless and warm as she works, comfortable as a woman in her own kitchen, and the comfort of it is the most frightening thing in the room.|n",
        "|xThe favourite at her feet is offered a sip from Bethany's own cup, and takes it with such uncomplicated gratitude that you feel the shape of your own future settle a little closer.|n",
        "|xShe catches you looking at the blank frame on the trophy wall and smiles, not unkindly. \"Soon,\" she says, and goes back to her file, and means it as a comfort.|n",
    ],
    "nursery": [
...
def force_clear(owner):
    ...
    for k in ("orgasm_denial", "exhibition_active", "self_cmds_locked", "endcycle_blocked",
              ...
              "rule_leave_permit", "rule_come_permit"):
