...
_CONTRACT_HIDDEN = [
    ...
    "H25. The Resident's own get, raised on her milk in the Nursery, mature into facility stock and are bred back to the Resident, generation upon generation — the line is grown through her body in perpetuity, each delivery raising her quota. |x— [lineage loop: her get breed her, deeper every generation]|n",
...
def run_facility_reset(caller, purge=False):
    ...
    caller.db.facility_forgotten = None
    caller.db.bethany_clauses = None
    caller.db.bethany_collar = False
    caller.db.bethany_line_only = False
